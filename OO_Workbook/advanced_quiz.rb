...
class SecretFile
  ...
  def initialize(secret_data, logger) ## added logger
    @data = secret_data
    ##
    @logger = logger
  end
...
#  the commonality into a separate class called WheeledVehicle. This is what
#  their code looks like so far:
...
#  efficiency and range. Modify the class definitions and move code into
#  a Module, as necessary, to share code among the Catamaran and the
#  wheeled vehicles.
